package com.flashartofwar.fcss.stylesheets
{
    ...
    public class StyleSheetCollectionTest
    {
        ...
        public function runBeforeEveryTest():void
        {
            ...
            styleSheetA.parseCSS(new CSSTidyUtil(cssTextA).toString());

            styleSheetB = new FStyleSheet("sheetB");
            styleSheetB.parseCSS(new CSSTidyUtil(cssTextB).toString());
        }
        ...
        {
            var tidyCSS:CSSTidyUtil = new CSSTidyUtil(cssTextA);

            styleSheetCollection.parseCSS(tidyCSS.toString());
            var sheet:IStyleSheet = styleSheetCollection.baseStyleSheet;

            Assert.assertEquals(sheet.toString(), tidyCSS.toString());
        }
